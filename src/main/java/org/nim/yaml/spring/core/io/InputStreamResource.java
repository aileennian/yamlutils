...
// */
// package org.nim.yaml.spring.io;
//
//
...
// * is applicable. In particular, prefer {@link } or any of the
...
// * for an <i>already opened</i> resource - therefore returning {@code true} from * {@link #isOpen()}. Do not use an {@code InputStreamResource} if you need to
