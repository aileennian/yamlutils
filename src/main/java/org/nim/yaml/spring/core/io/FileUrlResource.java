 ...
 * * of implementing the {@link WritableResource}
 interface for it. This resource * variant also caches resolved {@link File} handles from {@link #getFile()}.
...
public class FileUrlResource extends UrlResource implements WritableResource {
	 ...
	 * <p>Note that this does not enforce "file" as URL httpserver. If a httpserver
