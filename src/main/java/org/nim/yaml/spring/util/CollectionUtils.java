...
public abstract class CollectionUtils {	
	...
	/**
	 * Return {@code true}
 if the supplied Collection is {@code null}
 or empty.
...
.
	...
	/**
	 * Return {@code true}
 if the supplied Map is {@code null}
 or empty.
	 * Otherwise, return {@code false}
.
	 ...
	 * <p><b>NOTE:</b> Generally prefer the standard {@link Arrays#asList}
 method.
	 * This {@code arrayToList}
 method is just meant to deal with an incoming Object
	 * value that might be an {@code Object[]}
 ...
 source value will be converted to an empty List.
	 ...
	 * <p>Uses {@code Properties.propertyNames()}
 to even catch
 ...
 otherwise
	...
	/**
	 * Return {@code true}
 if any element in '{@code candidates}
' is
	 * contained in '{@code source}
';
...
.
	...
	/**
	 * Return the first element in '{@code candidates}
' that is contained in
	 * '{@code source}
'. If no element in '{@code candidates}
' is present in
	 * '{@code source}
' returns {@code null}
. Iteration order is
 ...
 implementation specific.
	 * @param source the source Collection
	 * @param candidates the candidates to search for
	 * @return the first present object, or {@code null}
 if not found
	 */
	@SuppressWarnings("unchecked")
 ...
 otherwise
	 ...
	 * @param collection the Collection to check
	 * @return the common element type, or {@code null}
 if no clear
...
.
	...
	/**
	 * Adapt a {@code Map<K, List<V>>}
 to an {@code MultiValueMap<K, V>}
.
	...
	public static <K, V> MultiValueMap<K, V> unmodifiableMultiValueMap(
			MultiValueMap<? extends K, ? extends V> targetMap) {		Assert.notNull(targetMap, "'targetMap' must not be null");
