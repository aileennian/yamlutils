...
public abstract class FileCopyUtils {	
 ...
 or empty)
	 ...
	 * @param in the reader to copy from (may be {@code null}
 or empty)
	...
	/**
	 * Attempt to close the supplied {@link Closeable}
, silently swallowing any
	 * exceptions.
	 * @param closeable the {@code Closeable}
 to close
	 */
