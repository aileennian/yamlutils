...
/**
* Miscellaneous {@code java.lang.Class}
utility methods.
 ...
 * type as value, for demo: Integer.class -> int.class.
 */
 ...
 * type as value, for demo: int.class -> Integer.class.
 */
 ...
 * type as value, for demo: "int" -> "int.class".
 */
 ...
 * ClassLoader, if available;
the ClassLoader that loaded the ClassUtils
 * class will be used as fallback.
 * <p>Call this method if you intend to use the thread context ClassLoader
 * in a scenario where you clearly prefer a non-null ClassLoader reference:
 * for demo, for class path resource loading (but not necessarily for
 * {@code Class.forName}
, which accepts a {@code null}
ClassLoader
 * reference as well).
 * @return the default ClassLoader (only {@code null}
if even the system
 ...
 * @return the original thread context ClassLoader, or {@code null}
if not overridden
 */
...
/**
 * Determine whether the {@link Class}
identified by the supplied name is present
 * and can be loaded. Will return {@code false}
 ...
 * @return the primitive class, or {@code null}
 ...
 * char, short, int, long, float, or double), {@code void}
, or a wrapper for
 ...
 * (also suitable for use with {@code Class.getResource}
by prepending a
 ...
 * although {@link ClassPathResource}
is usually
 ...
 * directly to {@code ClassLoader.getResource()}
. For it to be fed to
 * {@code Class.getResource}
instead, a leading slash would also have
 * to be prepended to the returned value.
 * @param clazz the input class. A {@code null}
 ...
 * in the given array.
 * <p>Basically like {@code AbstractCollection.toString()}
, but stripping
...
/**
 * Copy the given {@code Collection}
into a {@code Class}
array.
 * <p>The {@code Collection}
must contain {@code Class}
elements only.
 ...
 * extending the other), or {@code null}
if none found. If any of the
 * given classes is {@code null}
 ...
 * @return {@code true}
if the supplied class is an inner class
 * @since 5.0.5
 ...
 * e.g. "java.lang" for the {@code java.lang.String}
class.
 * @param clazz the class
 ...
 * <p>Essentially translates {@code NoSuchMethodException}
to "false".
 ...
 * if there is one. E.g. the method may be {@code IFoo.bar()}
and the
 ...
 * <p>Checks {@link Method#isSynthetic()}
(for implementation methods) as well as the
 * {@code GroovyObject}
interface (for interface methods;
on an implementation class,
 * implementations of the {@code GroovyObject}
methods will be marked as synthetic anyway).
 * Note that, despite being synthetic, bridge methods ({@link Method#isBridge()}
) are considered
 * as user-level methods since they are eventually pointing to a user-declared generic method.
 * @param method the method to check
 * @return {@code true}
if the method can be considered as user-declared;
[@code false}
otherwise
 */
 ...
 * @return the static method, or {@code null}
