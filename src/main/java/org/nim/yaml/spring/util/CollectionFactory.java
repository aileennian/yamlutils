...
public final class CollectionFactory {
	 ...
	 * i.e. a type that {@link #createApproximateCollection}
 can approximate.
	 * @param collectionType the collection type to check
	 * @return {@code true}
 if the type is <em>approximable</em>
	 */
	 ...
	 * <p><strong>Warning</strong>: Since the parameterized type {@code E}
 is
...
. In such scenarios, the caller
	 ...
	 * {@code collection}
 is an enum type matching type {@code E}
. As an
...
.
	 ...
	 * <p>Delegates to {@link #createCollection(Class, Class, int)}
 with a
	 * {@code null}
 element type.
 ...
 or of type {@link EnumSet}
	 ...
	 * <p><strong>Warning</strong>: Since the parameterized type {@code E}
 is
	 * not bound to the supplied {@code elementType}
, type safety cannot be
	 * guaranteed if the desired {@code collectionType}
 is {@link EnumSet}
.
	 * In such scenarios, the caller is responsible for ensuring that the
	 * supplied {@code elementType}
 is an enum type matching type {@code E}
.
...
.
	 ...
	 * @param elementType the collection's element type, or {@code null}
 if unknown
	 * (note: only relevant for {@link EnumSet}
 creation)
	 * @param capacity the initial capacity
	 * @return a new collection instance
	 * @since 4.1.3
 ...
 is
	 * {@code null}
;
 or if the desired {@code collectionType}
 is {@link EnumSet}
 and
	 * the supplied {@code elementType}
 is not a subtype of {@link Enum}
	 ...
	 * i.e. a type that {@link #createApproximateMap}
 can approximate.
...
,
	 * type safety cannot be guaranteed if the supplied {@code map}
 is an
	 * {@link EnumMap}
. In such scenarios, the caller is responsible for
	 * ensuring that the key type in the supplied {@code map}
 is an enum type
	 * matching type {@code K}
...
.
	 ...
	 * <p>Delegates to {@link #createMap(Class, Class, int)}
 with a
	 * {@code null}
 key type.
	 ...
	 * @throws IllegalArgumentException if the supplied {@code mapType}
 is
	 * {@code null}
 or of type {@link EnumMap}
...
;
 ...
 that sorts properties
	 * alphanumerically based on their keys.
	 * <p>This can be useful when storing the {@link Properties}
 instance in a
 ...
 that sorts properties
	 * alphanumerically based on their keys.
	 * <p>This can be useful when storing the {@code Properties}
 instance in a
	 * properties file, since it allows such files to be generated in a repeatable
	 * manner with consistent ordering of properties. Comments in generated
	 * properties files can also be optionally omitted.
	 * <p>The returned {@code Properties}
 instance will be populated with
	 * properties from the supplied {@code properties}
 object, but default
	 * properties from the supplied {@code properties}
