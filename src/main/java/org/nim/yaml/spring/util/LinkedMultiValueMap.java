...
import java.util.Map;
	...
	/**
 * Simple implementation of {@link MultiValueMap}
 that wraps a {@link LinkedHashMap}
,
...
.
	 ...
	 * the specified Map. Note that this will be a shallow copy;
 its value-holding
	 ...
	 * (consistently using an independent modifiable {@link LinkedList}
 for each entry)
	 * along the lines of {@code MultiValueMap.addAll}
 semantics
	 * @since 4.2
